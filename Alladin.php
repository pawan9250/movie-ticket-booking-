...
?>
              ...
              <iframe class="trailer" src="https://www.youtube.com/embed/foyufD52aog">watch trailer</iframe>
                <img src="alladin.jpg" style="width: 17%; height: 40%; float: left; position: absolute; top: 75%; left: 5%;">
             <h2 style="margin-left: 400px;">Aladin</h2>

               <form method="POST" style="margin: 0; " action="choose seat.php">
                <div style="font-weight: bold; width: 15px; height: 10px;">Theater F</div>
                <div style="">
        ...
        $query = "SELECT * FROM theater_a";
           ...
           <input type="hidden" name="theaterId" value="6">
            <input type="hidden" name="filmId" value="6">
              </div>
