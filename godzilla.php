...
?>
              ...
              <iframe class="trailer" src="https://www.youtube.com/embed/QFxN2oDKk0E">watch trailer</iframe>
                <img src="godzilla.jpg" style="width: 17%; height: 40%; float: left; position: absolute; top: 75%; left: 5%;">
             <h2 style="margin-left: 400px;">Godzilla King of monster</h2>

               <form method="POST" style="margin: 0; " action="choose seat.php">
                <div style="font-weight: bold; width: 15px; height: 10px;">Theater E</div>
                <div style="">
        ...
        $query = "SELECT * FROM theater_a";
           ...
           <input type="hidden" name="theaterId" value="5">
            <input type="hidden" name="filmId" value="5">
              </div>
