...
?>
              ...
              <iframe class="trailer" src="https://www.youtube.com/embed/Nt9L1jCKGnE">watch trailer</iframe>
                <img src="spiderman.jpeg" style="width: 17%; height: 40%; float: left; position: absolute; top: 70%; left: 5%;">
             <h2 style="margin-left: 400px;">Spider Man Far From Home</h2>

               <form method="POST" style="margin: 0; " action="choose seat.php">
                <div style="font-weight: bold; width: 15px; height: 10px;">Theater G</div>
                <div style="">
        ...
        $query = "SELECT * FROM theater_a";
           ...
           <input type="hidden" name="theaterId" value="7">
            <input type="hidden" name="filmId" value="7">
              </div>
